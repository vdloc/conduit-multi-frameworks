...
export default function Example() {
  return (
    <div className='bg-white'>
      ...
      {/* Logo cloud */}
      <div className='mx-auto max-w-7xl border-t border-gray-200 py-12 px-6 lg:py-20 lg:px-8'>
      ...
      {/* Footer */}
      <footer className='mx-auto mt-12 max-w-7xl py-12 px-6 lg:py-16 lg:px-8'>
