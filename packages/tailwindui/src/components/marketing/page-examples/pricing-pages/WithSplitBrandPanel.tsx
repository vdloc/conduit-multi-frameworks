    ...
    <div className='bg-white'>
      ...
      <div className='relative bg-white'>
        ...
        <div className='relative mx-auto max-w-7xl lg:grid lg:grid-cols-2 lg:px-8'>
          <div className='bg-white py-16 px-6 sm:py-24 lg:px-0 lg:pr-8'>
          ...
          <div className='bg-gradient-to-r from-cyan-600 to-green-400 py-16 px-6 sm:py-24 lg:flex lg:items-center lg:justify-end lg:bg-none lg:px-0 lg:pl-8'>
